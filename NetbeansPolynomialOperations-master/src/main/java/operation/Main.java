...
//                "The addition of the two polynomials is " + polyAddition.toString());
        ...
        poli1.addTerm(new Term(-2, 1));
        poli1.addTerm(new Term(-24, 0));
        double result = poli1.p(2);
        System.out.println("polynomial is: "+poli1.toString()+ " p(2) ="+result);
        
        //is 8.0X^3+21.0X^2-2.0X-24.0
        Polynomial hardcoded = new Polynomial();
        hardcoded.addTerm(new Term(8, 3));
        hardcoded.addTerm(new Term(21, 2));
        hardcoded.addTerm(new Term(-2, 1));
        hardcoded.addTerm(new Term(-24, 0));
        
        System.out.println();
        System.out.println("The hardcoded polynomial is: "+ hardcoded.toString() );
        double resultdo = hardcoded.p(2);
        System.out.println("p(2) = "+resultdo);
